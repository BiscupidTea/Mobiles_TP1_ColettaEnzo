...
public class GameManager : MonoBehaviour
{
    ...
    public GameObject[] Player1Cameras;
    public GameObject[] Player2Cameras;
    ...
    IEnumerator Start()
    {
        ...
        {
            Player1Cameras[i].SetActive(false);
            Player2Cameras[i].SetActive(false);
        }
    ...
    public void SetStartGame()
    {
        ...
        if (Multiplayer)
        {
            for (int i = 0; i < Player1Cameras.Length; i++)
            {
                Player1Cameras[i].SetActive(true);
                Player2Cameras[i].SetActive(true);
            }
        ...
        else
        {
            ...
            {
                Player1Cameras[i].SetActive(true);
                Player1Cameras[i].GetComponent<Camera>().rect = new Rect(0, 0, 1, 1);
            }
            Player1UI.SetActive(true);
        }
